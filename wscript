...
def build (bld):
    ...
    common = bld.objects (
        ...
        includes = ' libdash/libdash/qtsampleplayer/libdashframework/ /usr/local/include/libdash/ /usr/local/include/ns3-dev/ns3/ndnSIM/NFD/ /usr/local/include/ns3-dev/ns3/ndnSIM/NFD/daemon/ /usr/local/include/ns3-dev/ns3/ndnSIM/NFD/core/ /usr/local/include/ndn-cxx/ /usr/local/include/ns3-dev/ns3/ndnSIM/ /local/users/ndnsim2/include/ /local/users/ndnsim2/include/ns3-dev/ /local/users/ndnsim2/include/libdash/ /local/users/ndnsim2/include/ns3-dev/ns3/ndnSIM/NFD/ /local/users/ndnsim2/include/ns3-dev/ns3/ndnSIM/NFD/daemon/ /local/users/ndnsim2/include/ns3-dev/ns3/ndnSIM/NFD/core/ /local/users/ndnsim2/include/ndn-cxx/ /local/users/ndnsim2/include/ns3-dev/ns3/ndnSIM/'
        )
